...
// check local storage for best scores, set best score
...
function scoresToDOM() {
  ...
  updateBestScore();
  // scroll to top of container, go to score page
...
// add one tenth of a second to timePlayed
function addTime() {
  timePlayed += 0.1;
  checkTime();
}
...
function selectQuestionAmount(e) {
  ...
  console.log("QUESTION AMNT:", questionAmount);
  if (questionAmount) {
    showCountdown();
  }
}
